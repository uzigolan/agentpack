...
| Codex | Extract the Codex marketplace ZIP. Open Codex **Settings → Codex Settings → Plugins → Add → + Add a marketplace**, choose the extracted folder, then install the listed plugin. |
